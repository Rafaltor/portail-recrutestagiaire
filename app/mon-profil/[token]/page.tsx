          ...
          {authMessage ? (
            <p
              className={`mt-3 text-sm ${
                authStatus === "error" ? "text-red-700" : "text-zinc-700"
              }`}
            >
              {authMessage}
            </p>
        ...
        {linkStatus === "error" ? (
          <div className="mt-3 text-sm text-red-700">
            ...
            <button
              ...
              className="mt-2 inline-flex rounded-md border border-zinc-300 bg-white px-3 py-2 text-xs font-semibold text-zinc-800 hover:bg-zinc-100"
            >
