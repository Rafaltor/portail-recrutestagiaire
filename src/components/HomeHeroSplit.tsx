...
export function HomeHeroSplit() {
  ...
  return (
    <section className="rs-home-hero rs-home-hero--wide rs-home-hero--plain relative min-h-0 w-full overflow-hidden">
      <div className="rs-home-hero__grid--front relative z-[3] flex w-full flex-col">
        {/* Bandeau blanc pleine largeur (texte + CTA) */}
        <div className="w-full max-w-[100vw] border-b border-[#E8E8E8] bg-white px-2 pb-8 pt-5 sm:px-8 sm:pb-10 sm:pt-5 md:px-12 md:pb-12 md:pt-6 lg:px-16 lg:pb-14 lg:pt-8">
        ...
        <div className="w-full bg-white px-2 pb-7 pt-5 text-[#0A0A0A] sm:px-8 sm:pb-7 sm:pt-5 md:px-12 md:pb-9 md:pt-6 lg:px-16">
          <div className="mx-auto min-w-0 w-full max-w-[1200px]">
            <p className="font-[family-name:var(--font-syne)] text-[10px] font-bold uppercase tracking-[0.1em] text-[#6B6B6B] sm:text-[11px] sm:tracking-[0.14em]">
              En direct
            </p>
            <div className="mt-4 flex min-w-0 flex-row flex-wrap items-end gap-6 sm:mt-5 sm:gap-12 md:gap-16 lg:gap-24">
              <div className="min-w-0 flex-1 basis-0 sm:flex-none sm:basis-auto">
                ...
                <p className="mt-1.5 text-xs text-[#6B6B6B] sm:mt-2 sm:text-sm">CVs dans la base</p>
              </div>
              <div
                className="hidden h-[min(4.5rem,18vw)] w-px shrink-0 self-center bg-[#E8E8E8] sm:block sm:h-[72px] md:h-[88px]"
                aria-hidden
              />
              <div className="min-w-0 flex-1 basis-0 sm:flex-none sm:basis-auto">
                <p className="font-[family-name:var(--font-syne)] text-[clamp(1.85rem,11vw,2.75rem)] font-extrabold tabular-nums leading-none tracking-tight text-[#f472b6] sm:text-[52px] md:text-[68px] lg:text-[72px]">
                ...
                <p className="mt-1.5 text-xs text-[#6B6B6B] sm:mt-2 sm:text-sm">Votes enregistrés</p>
              </div>
            </div>
          </div>
        </div>
